      ...
      <div className="rounded-xl shadow-lg p-8 max-w-md w-full border" style={{ backgroundColor: '#FFF2E1', borderColor: '#D1BB9E' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="py-2 px-4 rounded-lg border flex items-center justify-center hover:opacity-90 transition duration-200"
              style={{ borderColor: '#D1BB9E', color: '#5A4638', backgroundColor: '#FFF2E1' }}
            >
